    ...
    return (
      <div className="flex-grow flex flex-col items-center justify-center py-section-padding">
        ...
        >
          ...
          <div>
            <h1 className="text-headline-lg text-on-surface mb-2">أهلاً بك، {user.displayName}</h1>
            <p className="text-body-md text-on-surface-variant">{user.email}</p>
          </div>

          <button
            onClick={() => logout()}
            className="w-full py-3 rounded-xl border border-error/40 text-error bg-error/10 hover:bg-error/20 transition-colors flex items-center justify-center gap-2 text-body-md font-medium"
          >
    ...
    <div className="flex-grow flex flex-col items-center justify-center py-section-padding">
      ...
      >
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-headline-lg text-on-surface">تسجيل الدخول</h1>
          <p className="text-body-md text-on-surface-variant mt-2">مرحباً بك مجدداً في منصة وثاق</p>
        </div>
